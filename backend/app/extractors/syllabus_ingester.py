"""
Syllabus Ingestion — Milestone 2.
Extracts raw text from syllabus PDF/DOCX, parses unit/topic structure,
stores in syllabi + syllabus_topics tables.
...
def ingest_syllabus(file_path: str, subject_id: str, regulation: str,
    ...
    parsed_units_json = [
        {"unit_number": u.unit_number, "unit_name": u.unit_name,
    ...
    if topic_rows:
        ...
        log.info(f"[SyllabusIngester] Stored {len(topic_rows)} topics")
