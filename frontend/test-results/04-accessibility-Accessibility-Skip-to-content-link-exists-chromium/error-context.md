...
- Name: 04-accessibility.spec.ts >> Accessibility >> Skip to content link exists
- Location: e2e/04-accessibility.spec.ts:32:3
...
Locator:  locator('a.skip-link, a[href="#main-content"]')
...
Call log:
  ...
  - waiting for locator('a.skip-link, a[href="#main-content"]')
    - waiting for" http://localhost:3001/auth" navigation to finish...
    - navigated to "http://localhost:3001/auth"
    12 × locator resolved to <a class="skip-link" href="#main-content">Skip to main content</a>
